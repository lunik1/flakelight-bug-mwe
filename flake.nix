    ...
    let
      ...
      overlays = [
        ...
        (self: super:
          # TODO: move to NUR
          {
            iosevka26 = self.iosevka.override
              rec {
